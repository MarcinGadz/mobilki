...
const EventListScreen = () => {
  ...
  const wrapperSetParentRadius = React.useCallback(val => {
  ...
  React.useEffect(() => {
    ...
    if (location) {
      ...
      axios
        .get("/event/get-near" + "?latitude=" +  location.latitude + "&longitude=" + location.longitude + "&radius=" + selectedRadius, {
          headers: {
  ...
  if (refreshing) {
    ...
    return (
      ...
      >
        <Search setParentRadius={wrapperSetParentRadius}/>
